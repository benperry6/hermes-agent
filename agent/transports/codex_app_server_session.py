...
def _record_kanban_projection_evidence(projection) -> None:
    """Bridge successful Codex tool completions into the Kanban run receipt."""
    ...
    try:
        ...
        record_successful_worker_tool(tool_name, runtime="codex")
    except Exception:
