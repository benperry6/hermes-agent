...
class TestMaterialToolEvidence:
    ...
    def test_only_successful_completed_tools_expose_metadata_only_evidence(
        self, item, expected,
    ) -> None:
        ...
        assert set(vars(projection)) == {
            "messages", "is_tool_iteration", "final_text", "material_tool_name"
        }
